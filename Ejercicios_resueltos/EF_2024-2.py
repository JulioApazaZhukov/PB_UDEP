...
def pedirTexto(mensaje,valores):
    while True:
...
while True:
    ...
    if op == 'c': break
        ...
        diferencia = difDeFechas(fecha1,fecha2)
        print(f"La diferencia de fechas es {diferencia}")
    elif op == 'b':
        ...
        nuevaFecha = sumDeFechas(fecha,cantidad,unidades)
        print(f"La nueva fecha es {nuevaFecha}")
    else:
